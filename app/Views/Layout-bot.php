...
<script src="public/asset/plugins/datatables-buttons/js/dataTables.buttons.min.js"></script>
<script src="public/asset/plugins/datatables-buttons/js/buttons.bootstrap4.min.js"></script>
<script src="public/asset/plugins/jszip/jszip.min.js"></script>
<script src="public/asset/plugins/pdfmake/pdfmake.min.js"></script>
<script src="public/asset/plugins/pdfmake/vfs_fonts.js"></script>
<script src="public/asset/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
<script src="public/asset/plugins/datatables-buttons/js/buttons.print.min.js"></script>
<script src="public/asset/plugins/datatables-buttons/js/buttons.colVis.min.js"></script>
<script>
  $(function () {
    $("#example1").DataTable({
